  ...
  store: {
    ...
    qa: [
      ...
      },
      {
        ...
        answer: 'Cool off with our chilled selection — **Thé Glacé d\'Hiver**, **Tiramisu Glacé**, and **Iced Punch Coco**. Effortslessly Parisian 🐴✨\n\n[Explore Menu 🏬](/store)'
      },
      {
  ...
  global: {
    qa: [
      ...
      },
      {
        ...
        answer: 'Discover the **+33 Paris** beverage menu — from classics like **Café Filtre**, **Cappuccino**, and **Latte / Flat White**, to our signature **Chai Latte**, **Pumpkin Latte**, **Matcha**, **Matcha Vanille**, **Thé Glacé d\'Hiver**, **Tiramisu Glacé**, and **Iced Punch Coco**! Sourced with our **Sachet de Café**! 🐴☕\n\n[Explore Menu 🏬](/store)'
      },
      {
